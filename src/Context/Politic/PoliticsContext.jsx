...
const PoliticsContext = createContext()

export const PoliticsProvider = ({ children }) => {

    const initialState = {
        PoliticsNews : [{"source":{"id":"the-times-of-india",
    ...
    const [state,dispatch] = useReducer(PoliticsReducer , initialState )

    return (
        <PoliticsContext.Provider value={{
            ...state,
            dispatch
            }}>
            {children}
...
export default PoliticsContext