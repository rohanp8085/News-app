...
const IplContext = createContext()

export const IplProvider = ({ children }) => {

    const initialState = {
        IplNews : [{"source":{"id":"the-times-of-india",
    ...
    const [state , dispatch] = useReducer(IplReducer,initialState)
